...
\newcommand{\bb}[1]{\lob #1\rob}
\newcommand{\bsb}[1]{\left[#1\right]}
\newcommand{\bra}[1]{\left\{#1\right\}}
\newcommand{\brac}[1]{\left\langle #1 \right|}
\newcommand{\ket}[1]{\left| #1 \right\rangle}
\newcommand{\bsa}[1]{\left\langle #1\right\rangle}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Data/Elementary/Notations}
\include{Data/Elementary/Sets}
\include{Data/Elementary/Numbers}
\include{Data/Elementary/Spaces}
%\include{Data/Elementary/Vectors}
%\include{Data/Temp/Logic_and_Set_Theory}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Algebra}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Data/Algebra/Groups}						%done
\include{Data/Algebra/Rings}							%done
\include{Data/Algebra/Linear_Algebra}			%half-done
\include{Data/Algebra/Matrix_Theory}						%p
%\include{Data/Algebra/Modules}					%p
%\include{Data/Temp/Linear_Algebra}			%Gaussian elimination
%\include{Data/Algebra/Galois_Theory}			%p
...
\part{Analysis}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Data/Analysis/Introduction}            					%p
\include{Data/Analysis/Elementary_Real_Analysis}							%p
\include{Data/Analysis/Analysis_in_Euclidean_Space}	
%\include{Data/Analysis/Multi_Dimensional_Real_Analysis}							%p
%\include{Data/Analysis/Fundamental_Analysis}			%p
\include{Data/Analysis/Complex_Analysis}						%p
%\include{Data/Temp/Numercial_Analysis}
%\include{Data/Temp/Basic_Analysis} 
%\include{Data/Temp/Analysis_II}
\include{Data/Analysis/Functions}
\include{Data/Analysis/Calculus}                					%p
\include{Data/Analysis/Metric_Space}							%p
\include{Data/Analysis/Matrix_Analysis} 						%p
\include{Data/Analysis/Topological_Space}					%p
\include{Data/Analysis/Measure_Theory}						%done
\include{Data/Analysis/Linear_Analysis}							%p
\include{Data/Analysis/Fourier_Analysis}						%p
%\include{Data/Temp/Linear_Analysis}
%\include{Data/Temp/Functional_Analysis}
%\include{Data/Analysis/Asymptotic_Analysis}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Numerical Analysis}
\include{Data/Numerical_Analysis/Numerical_Analysis}		%p
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\part{Topology}
%\include{Data/Calculus/Vector_Calculus}
%\include{Data/Calculus/Electromagnetism}
%\include{Data/Calculus/Matrix_Calculus}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\part{Number Theory}
\include{Data/Number_Theory/Elementary_Number_Theory}		%p
\include{Data/Number_Theory/Analytic_Number_Theory}		%p

\part{Dynamics}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Data/Dynamics/Ordinary_Differential_Equations}
\include{Data/Dynamics/Partial_Differential_Equations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Geometry}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Data/Geometry/Euclidean_Geometry}
\include{Data/Geometry/Spherical_Geometry}
\include{Data/Geometry/Hyperbolic_Geometry}
\include{Data/Geometry/Differential_Geometry}
%\include{Data/Temp/Geometry}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Discrete Mathematics}
\include{Data/Discrete_Mathematics/Graph_Theory}
\include{Data/Discrete_Mathematics/Combinatorics}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Probability}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Data/Probability/Probability}			           %done
\include{Data/Probability/Discrete_Stochastic_Processes}
\include{Data/Probability/Continuous_Stochastic_Processes}
\include{Data/Probability/Martingale_Theory}	
\include{Data/Probability/Markov_Chains}
\include{Data/Probability/Brownian_Motion}                  %done
\include{Data/Probability/Markov_Processes}
\include{Data/Probability/Levy_Process_and_Infinitely_Divisible_Distributions}
\include{Data/Probability/Stochastic_Calculus}              %p
\include{Data/Probability/Stochastic_Differential_Equations}
\include{Data/Probability/Diffusions}                       %p
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Statistics}
\include{Data/Statistics/Distributions}	                %p
\include{Data/Statistics/Statistics}                    %p
\include{Data/Statistics/Non_parametric_Estimation}
\include{Data/Statistics/Statistical_Tests}             %p
\include{Data/Statistics/Extreme_Value_Theory}
\include{Data/Statistics/Order_Statistics}
\include{Data/Statistics/Stable_Distribution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Optimization}
\include{Data/Optimization/Optimization}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Financial Mathematics}
\include{Data/Financial_Mathematics/Model}
%\include{Data/Financial_Mathematics/Futures}
\include{Data/Financial_Mathematics/Options}
\include{Data/Financial_Mathematics/Volatility}
%\include{Data/Financial_Mathematics/Asset_Allocation}
\include{Data/Financial_Mathematics/Contracting_Theory}
\include{Data/Financial_Mathematics/Risk}
...
%\include{Data/Temp/Coding_and_Cryptography/Coding_and_Cryptography}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\part{Coding and Cryptography}
%\include{Data/Quantum_Mechanics/Quantum_Mechanics}

%\part{Unsorted}
%\include{Data/Unsorted}
...
%\appendix
%\include{Data/Appendix/Calculus}
%\include{Data/Appendix/Differential_Equations}
%\include{Data/Appendix/Questions}
%\include{Data/Appendix/Unsorted}
