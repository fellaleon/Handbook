...
\pstProjection[linestyle=dashed]{D}{B}{A}[E]
\pstLineAB[linestyle=dashed]{D}{E}
\pstLineAB[linestyle=dashed]{A}{E}
\pstRightAngle[RightAngleSize=0.2]{D}{E}{A}
\pstOrtSym[PosAngle=90]{A}{B}{E}[F]
\pstLineAB[linestyle=dashed]{B}{F}
%\pstSymO[PosAngle=90]{F}{A}[G]
%\pstLineAB[linestyle=dashed]{G}{B}
%\pstLineAB[linestyle=dashed]{G}{A}
\pstRightAngle[RightAngleSize=0.2]{A}{F}{B}

%\pstSegmentMark[linestyle=dashed]{G}{F}
\pstSegmentMark[linestyle=dashed]{A}{F}
\pstSegmentMark[linestyle=dashed]{A}{E}
...
\be
S_{\triangle ABC} = \frac 12 AB \cdot BC \sin 80^\circ = \frac 12 AB^2 \sin 20^\circ \ \ra\ BC = \frac{\sin 20^\circ}{\sin 80^\circ}AB.
\ee
\be
S_{\triangle ABD} = \frac 12 AB \cdot BD \sin 10^\circ = \frac 12 AD\cdot BD \sin 150^\circ \ \ra\ AD = \frac{\sin 10^\circ}{\sin 150^\circ}AB.
\ee

However,
\be
\frac{\sin 20^\circ}{\sin 80^\circ} = \frac{2\sin 10^\circ \cos 10^\circ}{\cos 10^\circ} = \frac{\sin 10^\circ}{1/2} = \frac{\sin 10^\circ}{\sin 150^\circ}
\ee
...
\pscustom[linestyle=solid,fillstyle=solid,fillcolor=yellow!100,opacity=0.8]{
\psarcAB(A)(C)(D)
\psarcnAB(B)(D)(C)}

\pstSymO[]{C}{A}[E]
\pstSymO[]{C}{B}[F]
\pstMediatorAB[linestyle=none]{A}{E}{C}{M}
\pstMediatorAB[linestyle=none]{B}{F}{C}{N}
\pstMarkAngle[MarkAngleRadius=0.15,LabelSep=0.5,LabelAngleOffset=5]{M}{C}{N}{$\frac{\pi}9$}
\end{pspicture}
\end{center}
...
\pstGeonode[PointSymbol=none,PosAngle={90,45,45,90,-90}](0,0){O}(1.732,0){A}(5.6713,0){B}(0,1){C}(0,-1){D}%,PointName=none
\psset{PointSymbol=none,PointName=none,linewidth=0.5pt}
%\pstGeonode(-1.871,0.707){B1}(0,-2.828){AB1}(1.871,-0.707){A2}(-1.871,-0.707){B2}(0,2.828){AB2}(-2.828,0){CC}(2.828,0){DD}(0,2){N}(1.414,1.414){NE}
...
\pstMarkAngle[MarkAngleRadius=0.5,LabelSep=0.8,LabelAngleOffset=0]{A}{C}{B}{$\frac{\pi}9$}
\end{pspicture}
\end{center}

Then assume Kevin has $x$ bananas. We have that
\be
\frac{2\pi}{x-12} - \frac{2\pi}{x} = \angle CAD - \angle CBD = \frac {2\pi}9
\ee
which implies
\be
\frac{1}{x-12} - \frac 1x = \frac 19 \ \ra\ 9x - 9(x-12) = x(x-12) \ \ra\ x^2 - 12x - 108 = 0 \ \ra\ x = -6,18.
\ee
