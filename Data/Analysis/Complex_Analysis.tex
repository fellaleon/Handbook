...
In addition, for $z_2\neq 0$,
\be
\ol{\brb{\frac {z_1}{z_2}}} = \ol{z_1}/\ol{z_2}.
\ee
\end{proposition}
...
\eeast
\beast
\ol{\brb{\frac{z_1}{z_2}}} & = & \ol{\brb{\frac{x_1x_2 + y_1y_2 + i(-x_1y_2 + x_2y_1)}{x_2^2 + y_2^2} }} = \frac{x_1x_2 + y_1y_2 - i(-x_1y_2 + x_2y_1)}{x_2^2 + y_2^2}\\
...
%& = & x_1^2 x_2^2 + y_1^2y_2^2 + x_1^2y_2^2 + x_2^2 y_1^2 = \brb{x_1^2 + y_1^2}\brb{x_2^2 + y_2^2} = \abs{z_1}^2\abs{z_2}^2
%\eeast

For $z_3 \neq 0$,
\beast
\abs{\frac{z_1}{z_3}}^2 = \frac{z_1}{z_3}\ol{\brb{\frac{z_1}{z_3}}} = \frac{z_1}{z_3}\frac{\ol{z_1}}{\ol{z_3}} = \frac{z_1\ol{z_1}}{z_3\ol{z_3}} = \frac{\abs{z_1}^2}{\abs{z_3}^2}.
\eeast
\end{proof}
...
\beast
\abs{z_1+z_2}^2 = \abs{z_1}^2 + 2\Re \brb{z_1\ol{z_2}} + \abs{z_2}^2,\\
\abs{z_1-z_2}^2 = \abs{z_1}^2 - 2\Re \brb{z_1\ol{z_2}} + \abs{z_2}^2.
\eeast

Thus, we have
\be
\abs{z_1+z_2}^2 + \abs{z_1- z_2}^2 = 2\brb{\abs{z_1}^2 + \abs{z_2}^2}.
\ee
\end{proposition}
...
\beast
\abs{z_1+z_2}^2 & = & \brb{z_1 + z_2} \ol{ \brb{z_1 + z_2}} = \brb{z_1 + z_2} \brb{\ol{ z_1} + \ol{z_2}} = z_1 \ol{z_1} + z_1\ol{z_2} + z_2 \ol{z_1} + z_2\ol{z_2} \\
& = &  z_1 \ol{z_1} + z_1\ol{z_2} + \ol{z_1 \ol{z_2}} + z_2\ol{z_2} =  \abs{z_1}^2 + 2\Re\brb{z_1\ol{z_2}} + \abs{z_2}^2
\eeast
and
\beast
\abs{z_1-z_2}^2 & = & \brb{z_1 - z_2} \ol{ \brb{z_1 - z_2}} = \brb{z_1 - z_2} \brb{\ol{ z_1} - \ol{z_2}} = z_1 \ol{z_1} - z_1\ol{z_2} - z_2 \ol{z_1} + z_2\ol{z_2} \\
...
\beast
2x_1x_2y_1y_2 \leq x_1^2 y_2^2 + x_2^2 y_1^2 \ \ra\ \brb{x_1x_2 + y_1y_2}^2 \leq \brb{x_1^2+ y_1^2}\brb{x_2^2 + y_2^2} \ \ra\ x_1x_2 + y_1y_2 \leq \sqrt{x_1^2+ y_1^2}\sqrt{x_2^2 + y_2^2}.
\eeast

Therefore,
\beast
\abs{z_1+z_2}^2 & = & (x_1+x_2)^2+ (y_1+y_2)^2 = x_1^2+ x_2^2 + y_1^2+ y_2^2 + 2x_1x_2 + 2y_1y_2 \\
&\leq & x_1^2+ x_2^2 + y_1^2+ y_2^2 + 2\sqrt{x_1^2+ y_1^2}\sqrt{x_2^2 + y_2^2} = \brb{\sqrt{x_1^2+ y_1^2} + \sqrt{x_2^2 + y_2^2}}^2\\
& = & \brb{\abs{z_1} + \abs{z_2}}^2
\eeast
which implies the required result.

{\bf Approach 2.} Apply basic properties of modulus, we have
\beast
\abs{z_1+z_2}^2 & = &  \abs{z_1}^2 + 2\Re\brb{z_1\ol{z_2}} + \abs{z_2}^2 \leq \abs{z_1}^2 + 2\abs{\Re\brb{z_1\ol{z_2}}} + \abs{z_2}^2 \\
& \leq & \abs{z_1}^2 + 2\abs{z_1\ol{z_2}} + \abs{z_2}^2 = \abs{z_1}^2 + 2\abs{z_1}\abs{z_2} + \abs{z_2}^2 = \brb{\abs{z_1}+\abs{z_2}}^2
\eeast
...
\be
\lim_{n\to \infty} \brb{\frac 1{n^3} + i} = \lim_{n\to \infty} \frac 1{n^3} + i \lim_{n\to \infty} 1 = 0 + i\cdot 1 = i.
\ee
\end{example}
...
%\item [(iv)] We know that given $\ve > 0$, $\exists N_1(\ve),N_2(\ve)$ such that $|a_n - a| < \ve\ \forall n \geq N_1(\ve),\ |b_n - b| < \ve\ \forall n \geq N_2(\ve)$. Thus if $n \geq N(\ve) = \max\bra{N_1\brb{\frac{\ve}2}, N_2\brb{\frac{\ve}2}}$, we have
%\be
...
\be
\abs{z^n} = \abs{z}^n = \brb{1+\delta}^n > 1+ n\delta.
\ee
...
\be
\abs{z^{n+1} - zw} = \abs{z\brb{z^n -w}} = \abs{z}\abs{z^n-w} < \abs{z}\ve = \ve .
\ee
...
\be
\diam\brb{A} := \sup_{z,w\in A}\abs{z-w}.
\ee
\end{definition}
...
%\begin{theorem}
%The complex set $X\subseteq \C$ is compact if and only if every sequence $\brb{z_n}\subseteq X$ has a subsequence that converges to a point in $X$.
%\end{theorem}
...
\beast
S_n & = & \sum^n_{k=1} a_kb_k = a_{n+1}\sum^n_{k=1}b_k + \sum^n_{i=1}b_i\brb{a_i-a_{n+1}} = a_{n+1}B_n + \sum^n_{i=1}b_i\sum^n_{k=i}\brb{a_k-a_{k+1}} \\
& = & a_{n+1}B_n + \sum^n_{k=1}\brb{a_k-a_{k+1}} \sum^k_{i=1} b_i = a_{n+1}B_n + \sum^n_{k=1}B_k\brb{a_k-a_{k+1}}  .
\eeast
...
\be
\abs{B_k\brb{a_k-a_{k+1}}} \leq M(a_k-a_{k+1}).
\ee

But
\be
\sum^n_{k=1}M\brb{a_k-a_{k+1}} = M\sum^n_{k=1}\brb{a_k-a_{k+1}}
\ee
is a telescoping series that equals $M\brb{a_1 - a_{n+1}}$ ana therefore approaches $Ma_1$ as $n\to\infty$. Thus,
\be
\sum^\infty M\brb{a_1 - a_{n+1}} \quad \text{converges.}
\ee

Thus, by the comparison test (Theorem \ref{thm:comparison_test}),
\be
\sum^{\infty}_{k=1}\abs{B_k\brb{a_k-a_{k+1}}} \quad \text{converges} \quad \ra \quad \sum^{\infty}_{k=1}B_k\brb{a_k-a_{k+1}} \quad \text{converges}
\ee
...
\be
\abs{\sum^N_{n=1} b_n} = \abs{\sum^N_{n=1} \brb{re^{ix}}^n} =  \abs{\frac{1 - \brb{re^{ix}}^{n+1}}{1 - re^{ix}}} \leq \frac{1 +\abs{ \brb{re^{ix}}^{n+1}}}{\abs{1 - re^{ix}}} \leq \frac{2}{\abs{1 - re^{ix}}} := M.
\ee
...
\beast
\abs{\Re z_n - \Re z_0} & = & \abs{\Re\brb{z_n - z_0}} \leq \abs{z_n - z_0} \to 0,\\
\abs{\Im z_n - \Im z_0} & = & \abs{\Im\brb{z_n - z_0}} \leq \abs{z_n - z_0} \to 0.
\eeast
...
\be
\abs{f(z_n) - f(z_0)} = \abs{u(z_n) - u(z_0) + i\brb{v(z_n) - v(z_0)}} \leq \abs{u(z_n) - u(z_0)} + \abs{v(z_n) - v(z_0)} \to 0
\ee
...
\be
\abs{u(z_n) - u(z_0)} = \abs{\Re\brb{f(z_n) - f(z)}} \leq \abs{f(z_n) - f(z_0)} \to 0
\ee
...
& = & \frac{\ol{z}\brb{z-z_0} + z_0\brb{\ol{z} - \ol{z_0}}}{z-z_0} = \ol{z} + z_0 \frac{\ol{z} - \ol{z_0}}{z-z_0}
\eeast
...
\beast
\frac{e^{z}-1}{z} & = & \frac{e^x\cos y - 1 + ie^x \sin y}{x+ iy} = \frac{\brb{e^x\cos y - 1 + ie^x \sin y}\brb{x- iy}}{x^2+ y^2}\\
& = & \frac{x\brb{e^x\cos y - 1} + y e^x \sin y}{x^2+ y^2} + i\frac{x e^x\sin y - y\brb{e^x\cos y - 1}}{x^2+ y^2}
\eeast
...
\beast
e^x & = & 1 + x + \frac 12 x^2 + o\brb{x^2} \\
\sin y & = & y - \frac 16 y^3 + o\brb{y^3} \\
\cos y & = & 1 - \frac 12 y^2+ o\brb{y^2}
\eeast

Thus,
\beast
\lim_{z\to 0} \frac{e^{z}-1}{z} & = & \lim_{x,y\to 0} \frac{x\brb{\brb{1+x+ \frac 12 x^2 + o\brb{x^2}}\brb{1 - \frac 12 y^2+ o\brb{y^2}}-1 } + y  \brb{1+x+ \frac 12 x^2 + o\brb{x^2}} \brb{y - \frac 16 y^3 + o\brb{y^3}}}{x^2+ y^2} \\
& & + i\lim_{x,y\to 0} \frac{x \brb{1+x+ \frac 12 x^2 + o\brb{x^2}}\brb{y - \frac 16 y^3 + o\brb{y^3}} - y\brb{\brb{1+x+ \frac 12 x^2 + o\brb{x^2}}\brb{1 - \frac 12 y^2+ o\brb{y^2}}-1}}{x^2+ y^2}.
\eeast

For the real part,
\beast
& & \lim_{x,y\to 0} \frac{x\brb{\brb{1+x+ \frac 12 x^2 + o\brb{x^2}}\brb{1 - \frac 12 y^2+ o\brb{y^2}}-1 } + y  \brb{1+x+ \frac 12 x^2 + o\brb{x^2}} \brb{y - \frac 16 y^3 + o\brb{y^3}}}{x^2+ y^2}  \\
& = & \lim_{x,y\to 0} \frac{x\brb{\brb{1+x+ \frac 12 x^2}\brb{1 - \frac 12 y^2}-1 } + y  \brb{1+x+ \frac 12 x^2} \brb{y - \frac 16 y^3}}{x^2+ y^2}  \\
& = & \lim_{x,y\to 0} \frac{x\brb{x+ \frac 12 x^2 - \frac 12 y^2 - \frac 12 xy^2 - \frac 14 x^2y^2 } + y  \brb{y+xy+ \frac 12 yx^2  - \frac 16 y^3 - \frac 16 xy^3 - \frac 1{12}x^2y^3}}{x^2+ y^2}  \\
& = & \lim_{x,y\to 0} \frac{x\brb{x- \frac 12 y^2 - \frac 12 xy^2 } + y  \brb{y+xy+ \frac 12 yx^2}}{x^2+ y^2} = \lim_{x,y\to 0} \frac{x^2 + y^2 - \frac 12 xy^2  +xy^2 }{x^2+ y^2} = 1.
\eeast
For the imaginary part,
\beast
& & \lim_{x,y\to 0} \frac{x \brb{1+x+ \frac 12 x^2 + o\brb{x^2}}\brb{y - \frac 16 y^3 + o\brb{y^3}} - y\brb{\brb{1+x+ \frac 12 x^2 + o\brb{x^2}}\brb{1 - \frac 12 y^2+ o\brb{y^2}}-1}}{x^2+ y^2} \\
& = & \lim_{x,y\to 0} \frac{x \brb{1+x+ \frac 12 x^2}\brb{y - \frac 16 y^3 } - y\brb{\brb{1+x+ \frac 12 x^2 }\brb{1 - \frac 12 y^2}-1}}{x^2+ y^2} \\
& = & \lim_{x,y\to 0} \frac{xy + x^2y + \frac 12 x^3y  - y\brb{x+ \frac 12 x^2 }}{x^2+ y^2} = \lim_{x,y\to 0} \frac{xy + x^2y   - xy - \frac 12 x^2y }{x^2+ y^2} = 0.
\eeast
...
& \text{(iii)} & \frac{d}{dz}\brb{f(z)+g(z)} = f'(z) + g'(z), \\
& \text{(iv)} & \frac{d}{dz}\brb{f(z)g(z)} = f'(z)g(z) + f(z)g'(z), \\
& \text{(v)} & \frac{d}{dz}\brb{\frac{f(z)}{g(z)}} = \frac{f'(z)g(z) - f(z)g'(z)}{(g(z))^2}, \quad g(z) \neq 0\\
& \text{(vi)} & \frac{d}{dz}\brb{f\circ g(z)} =  \frac{d}{dz}\brb{f(g(z))} = f'(g(z))g'(z).\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad
\eeast
\end{proposition}
...
\frac{d}{dz}\brb{f(z)}^n & = & n\brb{f(z)}^{n-1} f'(z).
\eeast
\end{remark}
...
\item [(iii)]
\beast
\frac{d}{dz}\brb{f(z)+g(z)}  & = & \lim_{h\to 0}\frac{f(z+h)+g(z+h)-f(z)-g(z)}{h} \\
...
\beast
\frac{d}{dz}\brb{\frac 1{f(z)}} & = & \lim_{h\to 0}\frac{\phi(z+h)-\phi(z)}{h} = \lim_{h\to 0}\frac{1/f(z+h)-1/f(z)}{h} = \lim_{h\to 0}\frac{f(z)-f(z+h)}{hf(z+h)f(z)} = -\frac{f'(z)}{f^2(z)}
...
\be
\frac{d}{dz}\brb{z^2 + 2iz + 3}^4 = 4\brb{z^2 + 2iz + 3}^3 \frac{d}{dz}\brb{z^2 + 2iz + 3} = 8(z^2 + 2iz + 3)^3(z+i).
\ee
\end{example}
...
For $z = x+ iy\in \C$,
\be
\fp{}{z} = \frac 12 \brb{\fp{}{x} + \frac 1i \fp{}{y}},\qquad \fp{}{\ol{z}} = \frac 12 \brb{\fp{}{x} - \frac 1i\fp{}{y}}.
\ee
\end{definition}
...
\begin{proof}[\bf Proof]
\be
\fp{f}{\ol{z}}(z_0) = \frac 12\brb{\fp{f}{x}(z_0) + i\fp{f}{y}(z_0)} = \frac 12\brb{\fp{u}{x}(z_0) + i \fp{v}{x}(z_0) + i\fp{u}{y}(z_0)- \fp{v}{y}(z_0)} =0
\ee
by Cauchy-Riemann equations (Theorem \ref{thm:cauchy_riemann_equation}). Similarly, by Cauchy-Riemann equations again,
\beast
\fp{f}{z}(z_0) & = & \frac 12\brb{\fp{f}{x}(z_0) - i\fp{f}{y}(z_0)} = \frac 12\brb{\fp{u}{x}(z_0) + i \fp{v}{x}(z_0) - i\fp{u}{y}(z_0) + \fp{v}{y}(z_0)} \\
& = & \fp{u}{x}(z_0) + i \fp{v}{x}(z_0) = f'(z_0)
\eeast
\beast
\fp{u}{z}(z_0) & = & \frac 12\brb{\fp{u}{x}(z_0) - i\fp{u}{y}(z_0)} = \frac 12\brb{\fp{u}{x}(z_0) + i\fp{v}{x}(z_0)} = \frac 12 f'(z_0)
\eeast
as required.
...
& = & \bepm \Re\brb{\brb{\fp{u}{x}(x_0,y_0) + i\fp{v}{x}(x_0,y_0)}\cdot (h_1+ih_2)} \\
\Im\brb{\brb{\fp{u}{x}(x_0,y_0) + i\fp{v}{x}(x_0,y_0)}\cdot (h_1+ih_2)}\eepm = \bepm \Re\brb{f'(z_0)\cdot \delta } \\
\Im\brb{f'(z_0)\cdot \delta } \eepm
\eeast
...
& = & \brb{\fp{u}{x}(x_0,y_0)}^2 + \brb{\fp{u}{y}(x_0,y_0)}^2 = \abs{2\fp{u}{z}(z_0)}^2 = \abs{f'(z_0)}^2
\eeast
as required.
\end{proof}
...
\beast
f'(z_0)(z-z_0) & = & \ul{u_x(x_0,y_0)(x-x_0) + u_y(x_0,y_0)(y-y_0)} + i \brb{u_x(x_0,y_0)(y-y_0) - u_y(x_0,y_0)(x-x_0)} \\
& = & v_y(x_0,y_0)(x-x_0) - v_x(x_0,y_0)(y-y_0) + i\ul{\brb{v_y(x_0,y_0)(y-y_0) + v_x(x_0,y_0)(x-x_0)}}.
\eeast
...
u(x,y) - u(x_0,y_0) & = & u_x(x_0,y_0)(x-x_0) + u_y(x_0,y_0)(y-y_0) + o\brb{\abs{\Delta z}}, \\
& = & u_x(x_0,y_0)(x-x_0) - v_x(x_0,y_0)(y-y_0) +  o\brb{\abs{\Delta z}}.\qquad (*)
\eeast
and
\beast
v(x,y) - v(x_0,y_0) & = & v_x(x_0,y_0)(x-x_0) + v_y(x_0,y_0)(y-y_0) +o\brb{\abs{\Delta z}}, \\
& = & v_x(x_0,y_0)(x-x_0) + u_x(x_0,y_0)(y-y_0) + o\brb{\abs{\Delta z}}. \qquad (\dag)
\eeast
where
\be
...
\beast
f(z) -f(z_0) & = & \brb{u_x(x_0,y_0) + i v_x(x_0,y_0)}(x-x_0) + i\brb{u_x(x_0,y_0) + iv_x(x_0,y_0)}(y-y_0) + (1+i)o\brb{\abs{\Delta z}}  \\
& = & \brb{u_x(x_0,y_0) + i v_x(x_0,y_0)}(z-z_0) + (1+i) o\brb{\abs{\Delta z}}
\eeast

Thus,
\be
\frac{f(z) -f(z_0)}{z-z_0} = u_x(x_0,y_0) + i v_x(x_0,y_0) + (1+i) \frac{o\brb{\abs{\Delta z}}} {z-z_0}
\ee

Obviously,
\be
\lim_{z\to z_0}\abs{\frac{o\brb{\abs{\Delta z}}}{z-z_0}} = \lim_{z\to z_0}\frac{o\brb{\abs{\Delta z}}}{\abs{z-z_0}} = \lim_{\Delta z\to 0}\frac{o\brb{\abs{\Delta z}}}{\abs{\Delta z}} = 0
\ee
...
%\be
%\lim_{x\to x_0,y\to y_0} \frac{\abs{f(x,y)-f(x_0,y_0) - \brb{\fp{f}{x}(x_0,y_0)(x-x_0) +\fp{f}{y}(x_0,y_0)(y-y_0)}}}{\sqrt{(x-x_0)^2 + (y-y_0)^2}} = 0.
%\ee
\end{remark}
...
\be
\lim_{z\to 0} \frac{\ol{z}^2/z}{z} =  \lim_{x\to 0} \frac{(1-i)^2x^2}{(1+i)^2x^2} = \brb{\frac{1-i}{1+i}}^2 = -1.
\ee
\een
\end{example}
...
\be
f(z) = (x+iy)^3 = x^3 - 3xy^2 + i\brb{3x^2y - y^3} \ \ra\ u(x,y) = x^3 - 3xy^2,\ v(x,y) = 3x^2y - y^3.
\ee
...
\be
f'(z) = u_x(x,y) + iv_x(x,y) = 3x^2 - 3y^2 + 6i xy = 3\brb{x^2 - y^2 + 2i xy} = 3\brb{x+iy}^2 = 3z^2.
\ee
\end{example}
...
\be
\brb{\Log(z)}' = \frac{1}{\exp'(\Log(z))} =  \frac{1}{\exp(\Log(z))} = \frac 1z.
\ee
\end{example}
...
\be
\sum^\infty_{n=0} a_n(z-z_0)^n = a_0 + a_1(z-z_0) + a_2 \brb{z-z_0}^2 + \dots
\ee
...
\be
\abs{a_n z^n} \leq \brb{t+\ve}^n r^n = \rho^n
\ee
...
\be
\abs{a_n z^n} > \abs{\brb{t-\ve}^n\brb{\frac 1{t-\ve}}^n} = 1 \nrightarrow 0.
\ee
...
%\be
%\sum_{n\to \infty}\brb{\abs{a_n}R^n }^{1/n} := \sum_{n\to \infty}\brb{\abs{a_{n_1}\dots a_{n_d}}R_1^{n_1}\dots R_d^{n_d}}^{1/n} = 1.
%\ee
%\end{theorem}
%
%\begin{proof}[\bf Proof]
...
\be
\abs{\frac{a_{n+1}}{a_n}} = \abs{\frac{(n+1)^{n+1}}{n^n}} = (n+1)\brb{\frac{n+1}{n}}^n = (n+1)\underbrace{\brb{1 + \frac 1n}^n}_{\to e} \to \infty \ \ra \ R=0.
\ee
\een
\end{example}
...
& \leq & \frac 2{\abs{1-z}}\brb{\frac 1m + \frac 1n + \sum^{m-1}_{i=n}\brb{\frac 1i - \frac 1{i+1}}} = \frac 4{n\abs{1-z}}.
\eeast
...
& = & \brb{\frac{S_N(z_0+h)-S_N(z_0)}{h}- S_N'(z_0) } + \brb{S_N'(z_0) - g(z_0)} + \brb{\frac{E_N(z_0+h)- E_N(z_0)}{h}}
\eeast
where $S_N'(z_0)$ is the derivative of $S_N(z_0)$. Since for any $a,b\in \C$,
\be
a^n - b^n = (a-b)\brb{a^{n-1} + a^{n-2}b + \dots + ab^{n-2}+b^{n-1}},
\ee
we can have
\be
...
\be
\brb{e^z}' = \sum^\infty_{n=1}\frac n{n!}z^{n-1} = e^z.
\ee
...
\be
z = \sqrt{x^2 + y^2}\frac{x}{\sqrt{x^2 + y^2}} + i\sqrt{x^2 + y^2}\frac{y}{\sqrt{x^2 + y^2}} = r\cos\theta \pm i r \sin \theta = r\cos\brb{\pm\theta} + i r \sin \brb{\pm\theta}
\ee
...
Then
\be
\cos\brb{\theta_1 - \theta_2} = \cos \theta_1 \cos\theta_2 + \sin\theta_1\sin\theta_2 = \cos^2 \theta_1 + \sin^2 \theta_1 = 1 \ \ra\ \theta_1 - \theta_2 = 2k\pi,\ k\in\Z
\ee
...
\be
z_1z_2  =r_1r_2\brb{\cos(\theta_1+\theta_2) + i\sin (\theta_1+\theta_2)}
\ee
\end{proposition}
...
\be
z = r\brb{\cos\theta + i\sin\theta} = re^{i\theta}.
\ee
...
\Arg z = \left\{\ba{ll}
\arctan\brb{y/x} & x>0,\\
\arctan\brb{y/x} + \pi\quad\quad\quad\quad & x<0,y\geq 0,\\
\arctan\brb{y/x} - \pi\quad\quad & x<0,y< 0,\\
\pi/2 & x=0,y> 0,\\
-\pi/2 & x=0,y< 0,\\
...
\Arg z = \left\{\ba{ll}
\arctan\brb{y/x} & x>0,\\
\pi/2 - \arctan\brb{x/y}\quad\quad\quad\quad & y>0,\\
-\pi/2 -\arctan\brb{x/y} \quad\quad & y< 0,\\
\arctan\brb{y/x} \pm \pi & x < 0,\\
\text{undefined} & x=0,y=0
\ea\right.
\ee
\end{remark}
...
\be
\frac{y}{x} = \frac{r\sin\theta}{r\cos\theta} = \frac{\sin\theta}{\cos\theta} = \tan\theta = \tan\brb{\arg z} = \tan\brb{\Arg z + 2k\pi} = \tan\brb{\Arg z},\quad k\in \Z.
\ee
...
For product,
\beast
z_1 z_2 = \abs{z_1z_2}e^{i\brb{\Arg z_1 + \Arg z_2}}  \ \ra\ \Arg\brb{z_1z_2} = \Arg z_1 + \Arg z_2 \lmod{(-\pi,\pi]}.
\eeast

For division,
\beast
\frac{z_1}{z_2} = \frac{\abs{z_1}e^{i\Arg z_1}}{\abs{z_2}e^{i\Arg z_2}} = \abs{\frac{z_1}{z_2}}e^{i\Arg z_1}e^{- i\Arg z_2} = \abs{\frac{z_1}{z_2}}e^{i\brb{\Arg z_1 - \Arg z_2}}  \ \ra\ \Arg\brb{\frac{z_1}{z_2}} = \Arg z_1 - \Arg z_2 \lmod{(-\pi,\pi]}.
\eeast
...
\be
\abs{z_n - z} = \abs{e^{i/n}-1}\abs{z} = \abs{z}\abs{\cos \frac 1n -1 + i\sin \frac 1n} = \abs{z}\sqrt{2 - 2\cos \frac 1n} = 2\abs{z}\sin\brb{\frac 1{2n}} \leq 2\abs{z}\frac 1{2n} = \frac{\abs{z}}{n} \to 0
\ee
...
and
\be
\fp{\theta}{x} = \frac{1}{1+\brb{\frac yx}^2} \brb{-\frac{y}{x^2}} = -\frac{y}{x^2+y^2} = -\frac 1r\sin \theta,\qquad \fp{\theta}{y} = \frac{1}{1+\brb{\frac yx}^2} \brb{\frac{1}{x}} = \frac{x}{x^2+y^2} = \frac 1r\cos\theta.
\ee
...
\beast
0 & = & \fp{u}{x} - \fp{v}{y} = \brb{\fp{u}{r}- \frac 1r \fp{v}{\theta} } \cos\theta - \brb{\fp{v}{r} + \frac 1r \fp{u}{\theta} } \sin\theta \\
0 & = & \fp{v}{x} + \fp{u}{y} = \brb{\fp{v}{r}+ \frac 1r \fp{u}{\theta} } \cos\theta + \brb{\fp{u}{r} - \frac 1r \fp{v}{\theta} } \sin\theta
\eeast
...
\be
f'(z_0) = e^{-i\theta_0} \brb{u_r(r_0,\theta_0) + iv_r(r_0,\theta_0)} = \frac 1{r_0}e^{-i\theta_0}\brb{ v_\theta(r_0,\theta_0) - iu_\theta(r_0,\theta_0)}.
\ee
\end{theorem}
...
\be
\lim_{r\to r_0,\theta\to \theta_0} \frac{\abs{f(r,\theta)-f(r_0,\theta_0) - \brb{\fp{f}{r}(r_0,\theta_0)(r-r_0) +\fp{f}{\theta}(r_0,\theta_0)(\theta-\theta_0)}}}{\sqrt{r^2 + r_0^2 - 2rr_0 \cos(\theta-\theta_0)}} = 0.
\ee
\end{remark}
...
\beast%& = & u(x,y) - u(x_0,y) + u(x_0,y) - u(x_0,y_0) \\
u(r,\theta) - u(r_0,\theta_0) & = & u_r(r_0,\theta_0)(r-r_0) + u_\theta(r_0,\theta_0)(\theta-\theta_0) + o\brb{\abs{\Delta z}}, \\
& = & u_r(r_0,\theta_0)(r-r_0) - r_0 v_r(r_0,\theta_0)(\theta-\theta_0) +  o\brb{\abs{\Delta z}}.\qquad (*)
\eeast
and
\beast
v(r,\theta) - v(r_0,\theta_0) & = & v_r(r_0,\theta_0)(r-r_0) + v_\theta(r_0,\theta_0)(\theta-\theta_0) +o\brb{\abs{\Delta z}}, \\
& = & v_r(r_0,\theta_0)(r-r_0) + r_0 u_r(r_0,\theta_0)(\theta-\theta_0) + o\brb{\abs{\Delta z}}. \qquad (\dag)
\eeast
where
\beast
\abs{\Delta z} & = & \sqrt{r^2 + r_0^2 - 2rr_0\cos(\theta-\theta_0)} \\
& = & \sqrt{(r- r_0)^2 + 2rr_0\brb{1-\cos(\theta-\theta_0)}} \\
& = & \sqrt{(r- r_0)^2 + rr_0(\theta-\theta_0)^2 + o\brb{(\theta-\theta_0)^2}}
\eeast

Then $(*)+ i\cdot (\dag)$ gives that
\beast
& & f(z) -f(z_0)\\
& = & \brb{u_r(r_0,\theta_0) + i v_r(r_0,\theta_0)}(r-r_0) + ir_0 \brb{u_r(r_0,\theta_0) + iv_r(r_0,\theta_0)}(\theta-\theta_0) + (1+i)o\brb{\abs{\Delta z}}  \\
& = & e^{-i\theta_0}\brb{u_r(r_0,\theta_0) + i v_r(r_0,\theta_0)}(re^{i\theta}-r_0e^{i\theta_0}) + \brb{u_r(r_0,\theta_0) + iv_r(r_0,\theta_0)}\brb{r-r e^{i(\theta-\theta_0)} + i r_0(\theta-\theta_0)} + (1+i) o\brb{\abs{\Delta z}} \\
& = & e^{-i\theta_0}\brb{u_r(r_0,\theta_0) + i v_r(r_0,\theta_0)}(z-z_0) + \brb{u_r(r_0,\theta_0) + iv_r(r_0,\theta_0)}\brb{r-r e^{i(\theta-\theta_0)} + i r_0(\theta-\theta_0)} + (1+i) o\brb{\abs{\Delta z}}.
\eeast

Thus,
\beast
\frac{f(z) -f(z_0)}{z-z_0} = e^{-i\theta_0}\brb{u_r(r_0,\theta_0) + i v_r(r_0,\theta_0)} + \brb{u_r(r_0,\theta_0) + iv_r(r_0,\theta_0)}\frac{\brb{r-r e^{i(\theta-\theta_0)} + i r_0(\theta-\theta_0)}}{z-z_0} + (1+i) \frac{o\brb{\abs{\Delta z}}} {z-z_0}
\eeast
%
Obviously,
\be
...
\beast
\lim_{z\to z_0}\abs{\frac{\brb{r-r e^{i(\theta-\theta_0)} + i r_0(\theta-\theta_0)}}{z-z_0}} & = & \lim_{z\to z_0}\frac{\abs{\brb{r\brb{-i(\theta-\theta_0) + \frac 12(\theta-\theta_0)^2 + o\brb{(\theta-\theta_0)^2} } + i r_0(\theta-\theta_0)}}}{\abs{\Delta z}} \\
& = & \lim_{z\to z_0}\frac{\abs{\frac 12r(\theta-\theta_0)^2 + r\cdot o\brb{(\theta-\theta_0)^2 } + i (r_0-r)(\theta-\theta_0)}}{\abs{\Delta z}} \\
& \leq  & \lim_{z\to z_0}\frac{\abs{\frac 12r(\theta-\theta_0)^2} + r\abs{o\brb{(\theta-\theta_0)^2}} + \abs{(r_0-r)(\theta-\theta_0)}}{\abs{\Delta z}} \to 0.
\eeast

Therefore,
\be
f'(z) = \lim_{z\to z_0}\frac{f(z) -f(z_0)}{z-z_0} = e^{-i\theta_0}\brb{u_r(r_0,\theta_0) + i v_r(r_0,\theta_0)} = \frac 1{r_0}e^{-i\theta_0}\brb{ v_\theta(r_0,\theta_0) - iu_\theta(r_0,\theta_0)}.
\ee
\end{proof}
...
\be
f(z) = f\brb{re^{i\theta}} = \brb{r\cos \theta + ir\sin\theta}^2 = r^2\cos(2\theta) + ir^2 \sin(2\theta) = u(r,\theta) + i v(r,\theta).
\ee
...
v_r(r,\theta) & = & 2r\sin(2\theta) = -\frac 1r \brb{-2r^2\sin(2\theta)} = - \frac 1r u_\theta(r,\theta).
\eeast
...
\be
f'(z_0) = e^{-i\theta_0}\brb{u_r(r_0,\theta_0) + i v_r(r_0,\theta_0)} = e^{-i\theta_0}\brb{2r_0\cos(2\theta_0) + 2ir_0\sin(2\theta_0)} = 2r_0\brb{\cos \theta_0 + i\sin\theta_0} = 2z_0.
\ee
\end{example}
...
Let function
\be
f(z) = z^{1/2} = \brb{re^{i\theta}}^{1/2} = r^{1/2}\brb{\cos\frac{\theta}2 + i\sin\frac{\theta}2}.
\ee

Then
\be
f'(z) = \frac 1{2}z^{-1/2} = \frac 12 \brb{re^{i\theta}}^{-1/2}= \frac 12 r^{-1/2} \brb{\cos\frac{\theta}2 - i\sin\frac{\theta}2}
\ee
...
v_r(r,\theta) & = & \frac 12 r^{-1/2} \sin \frac{\theta}2 = -\frac 1r \brb{-\frac 12r^{1/2}\sin\frac{\theta}2} = -\frac 1r u_\theta(r,\theta).
\eeast
...
\beast
f'(z_0) & = & e^{-i\theta_0}\brb{u_r(r_0,\theta_0) + i v_r(r_0,\theta_0)} = e^{-i\theta_0}\brb{\frac 12 r_0^{-1/2} \cos\frac{\theta_0}2 + \frac 12i r_0^{-1/2} \sin \frac{\theta_0}2} \\
& = & \frac 12 r_0^{-1/2} e^{-i\theta_0} e^{i\theta_0/2} = \brb{r_0e^{i\theta_0}}^{-1/2}  = \frac 12 z_0^{-1/2}.
\eeast
...
\beast
\int^{2\pi}_0 e^{iat}dt & = & \int^{2\pi}_0 \brb{\cos (at) + i\sin(at)} dt = \int^{2\pi}_0 \cos (at) dt + i \int^{2\pi}_0 \sin(at) dt \\
& = & \frac 1{a}\brb{\sin (2\pi a)  - i\brb{\cos(2\pi a)-1} } = \frac 1a\brb{-ie^{i 2\pi a} + i} = \frac 1{ia}\brb{e^{i 2\pi a}-1} = \left.\frac 1{ia}e^{ia t}\right|^{2\pi}_0
\eeast
...
\be
\int^{2\pi}_0 e^{a t}\cos(bt) =\left. \frac 1{a^2 + b^2}\brb{be^{at}\sin(bt) + ae^{at}\cos (bt)}\right|^{2\pi}_0
\ee
and the imaginary part is
\be
\int^{2\pi}_0 e^{a t}\sin(bt) =\left. \frac 1{a^2 + b^2}\brb{-be^{at}\cos(bt) + ae^{at}\sin( bt)}\right|^{2\pi}_0.
\ee

Thus,
\beast
\int^{2\pi}_0 e^{\alpha t}dt = \left.  \frac 1{a^2 + b^2} \brb{ae^{at}e^{ibt} - ib e^{at}e^{ibt}} \right|^{2\pi}_0 = \left. \frac 1{a+bi} e^{(a + ib)t} \right|^{2\pi}_0 = \left. \frac {e^{\alpha t}}{\alpha}  \right|^{2\pi}_0
\eeast
...
\be
\Re \brb{\int^b_a f(t)dt} = \int^b_a \Re\brb{f(t) }dt  = \int^b_a u(t)dt.
\ee

\item [(ii)] The imaginary part of line integral
\be
\Im \brb{\int^b_a f(t)dt} = \int^b_a \Im\brb{f(t) }dt  = \int^b_a v(t)dt.
\ee

\item [(iii)] For any complex numbers $\alpha$ and $\beta$,
\be
\int^b_a \brb{\alpha f(t) + \beta g(t)}dt = \alpha \int^b_a f(t) dt + \beta \int^b_a g(t) dt.
\ee
...
For (v), we consider
\be
\int^b_a f(t)dt = \abs{\int^b_a f(t)dt} e^{i\phi},\qquad \phi = \Arg \brb{\int^b_a f(t)dt}.
\ee

Since $\abs{\int^b_a f(t)dt}$ is real, we deduce that by (iii) and (i)
\beast
\abs{\int^b_a f(t)dt} & = & e^{-i\phi} \int^b_a f(t)dt = \int^b_a e^{-i\phi} f(t)dt = \Re\brb{\int^b_a e^{-i\phi} f(t)dt} \\
& = & \int^b_a \Re\brb{e^{-i\phi} f(t)}dt \leq \int^b_a \abs{e^{-i\phi} f(t)}dt = \int^b_a \abs{f(t)}dt.
\eeast
\end{proof}
...
\beast
\abs{\Gamma_k(s) - \gamma_k(\sigma_i)} &  = &  \abs{\frac 1{s_i - s_{i-1}} \brb{(s_i-s)(\gamma_k(s_{i-1})-\gamma_k(\sigma_i)) + (s-s_{i-1})(\gamma_k(s_i)-\gamma_k(\sigma_i))}} \\
...
& = & \ve + \abs{\sum^m_{i=1}  \frac{\gamma_k(s_i) - \gamma_k(s_{i-1})}{s_i - s_{i-1}}\int^{s_i}_{s_{i-1}} \brb{f(\gamma_k(\sigma_i))- f(\Gamma_k(s))}ds} < \ve + \ve \sum^m_{i=1} \abs{\gamma_k(s_i) - \gamma_k(s_{i-1})} \\
& \leq & \ve \brb{1 + V_{\gamma_k}[t_{k-1},t_k]}.
\eeast
...
\be
\int_\gamma f = \int_{\gamma\circ \phi}f \qquad \brb{\int_\gamma f(z)dz = \int_{\gamma\circ \phi}f(z)dz}.
\ee
\end{proposition}
...
Therefore,
\beast
\abs{g(w)-g(z)} & = & \abs{\int^b_a f(t,w)dt - \int^b_a f(t,z)dt} = \abs{\int^b_a \brb{f(t,w)-f(t,z)}dt} \\
...
\be
\abs{\int_\gamma \brb{\fp{f}{z}(t,\xi) - \fp{f}{z}(t,z)}d\xi} < \frac{\ve }{b-a} \int_\gamma \abs{d\xi} = \frac{\ve \abs{w-z}}{b-a}
\ee
...
& = & \abs{\int_\gamma \brb{\fp{f}{z}(t,\xi) - \fp{f}{z}(t,z)}d\xi} < \frac{\ve \abs{w-z}}{b-a}.
\eeast
...
%\be
%\abs{\int_\gamma \brb{\fp{f}{z}(t,\xi) - \fp{f}{t}(s,z)}d\xi} < \frac{\ve \abs{w-z}}{b-a}.
%\ee

Then we have
\beast
& & \abs{\frac{g(w)-g(z)}{w-z} - \int^b_a \fp{f}{z}(t,z) dt} \\
& = & \abs{\frac{\int^b_a f(t,w)dt - \int^b_a f(t,z)dt}{w-z} - \int^b_a \fp{f}{z}(t,z) dt} = \frac 1{\abs{w-z}}\abs{\int^b_a \brb{f(t,w)-f(t,z) -(w-z) \fp{f}{z}(t,z)} dt} \\
& \leq & \frac 1{\abs{w-z}}\int^b_a \abs{\brb{f(t,w)-f(t,z) -(w-z) \fp{f}{z}(t,z)}} dt < \frac 1{\abs{w-z}} \frac{\ve \abs{w-z}}{b-a} \int^b_a dt = \ve
\eeast
when $\abs{w-z} < \delta$.
\end{proof}
...
\beast
\int_C f(z)dz & = & \lim_{\lm\to 0} \sum^{n}_{k=1} f(\xi_k)\Delta z_k = \lim_{\lm\to 0} \sum^{n}_{k=1} \brb{u(\xi_k) + iv(\xi_k)}\brb{\Delta x_k + i\Delta y_k} \\
& = & \lim_{\lm\to 0} \sum^{n}_{k=1} \brb{u(x(t_k),y(t_k)) + iv(x(t_k),y(t_k))}\brb{\frac{\Delta x_k}{\Delta t_k} + i\frac{\Delta y_k}{\Delta t_k}} \Delta t_k
\eeast
...
& = & \int^b_a \brb{u(x(t),y(t)) + i v(x(t),y(t))}\brb{\frac {dx(t)}{dt} + i \frac {dy(t)}{dt}}dt = \int^b_a f(z(t)) \frac{dz(t)}{dt} dt.
\eeast
\end{proof}
...
& = & M \int^b_a \sqrt{\brb{\frac{dx(t)}{dt}}^2 +\brb{\frac{dy(t)}{dt}}^2} dt = ML.
\eeast
\een
\end{proof}
...
\item [(i)] The straight line segment joining 1 and $2+i$. The parametric form of the straight line segment joining 1 and $2+i$ is given by \be
    ...
    \beast
    \int_C \frac 1{z^2} dz & = & \int^1_0 \frac 1{z^2(t)}z'(t)dt = \int^1_0 \frac{1+i}{\brb{1+(1+i)t}^2}dt \\
...
Thus,
\be
\int_C \frac 1{z^2} dz = (1+i)\brb{\frac 25 - \frac 15 i} = \frac{3+i}{5}.
\ee
...
Then
\be
\int_C \abs{z}^2 dz = (1+i)\int^1_0 (2t^2 - 2t+1) dt = (1+i) \brb{\frac 23 - 1 + 1} = \frac 23 (1+i).
\ee
...
and this means that
\be
\oint_{C_i} f(z)dz = \brb{f(z_i) - z_i f'(z_i)}\oint_{C_i}dz + f'(z_i)\oint_{C_i}zdz + \oint_{C_i}(z-z_i)\delta_i(z)dz.
\ee
...
\be
\abs{\oint_C f(z)dz} < \brb{4\sqrt{2}S^2 + \sqrt{2}SL}\ve.
\ee
...
Evaluate the integral
\be
\oint_C \brb{\abs{z} - e^{z}\sin z^2 + \ol{z}}dz
\ee
where $C$ is the circle $\abs{z} = a$. The integral can be split into three individual integrals as
\be
\oint_C \brb{\abs{z} - e^{z}\sin z^2 + \ol{z}}dz = \oint_C \abs{z} dz - \oint_C e^{z}\sin z^2 dz + \oint_C  \ol{z}dz
\ee
...
\int_{C_3} e^{-z^2}dz & = & \int^{-a}_a e^{-(x+ib)^2} dx = -e^{b^2} \brb{\int^a_{-a} e^{-x^2}\cos(2bx)dx - i \int^a_{-a} e^{-x^2}\sin(2bx)dx},\\
...
\be
0 = \lim_{a\to\infty} \oint_C e^{-z^2}dz = \lim_{a\to\infty} \brb{\int^a_{-a} e^{-x^2}dx - e^{b^2} \int^a_{-a} e^{-x^2}\cos(2bx)dx} + ie^{b^2}\lim_{a\to\infty} \brb{ \int^a_{-a} e^{-x^2}\sin(2bx)dx}.
\ee
...
\be
f^{(n)}(z) = \frac {n!}{2\pi i}\int_C \frac{f(\xi)}{\brb{\xi-z}^{n+1}}d\xi
\ee
...
%\be
%\frac{d}{dz}\brb{\int^b_a f(t,z) dt} = \int^b_a \fp{f(t,z)}{t}dt.
%\ee
%\end{theorem}
...
\be
\res\bsb{f,c} = \frac 1{(n-1)!} \lim_{z\to c} \frac{d^{n-1}}{dz^{n-1}}\brb{(z-c)^n f(z)}.
\ee
\end{proposition}
...
\be
f(z) = f(0)e^{\frac{f'(0)}{f(0)}z} \prod^\infty_{n=1}\brb{\brb{1-\frac z{a_n}}e^{\frac{z}{a_n}}}.
\ee
\end{theorem}
...
\be
\frac{f'(z)}{f(z)} = \frac{f'(0)}{f(0)} + \sum^\infty_{n=1}\brb{\frac 1{z-a_n} + \frac 1{a_n}}.
\ee
...
\be
f(z) = ce^{\frac{f'(0)}{f(0)}z} \prod^\infty_{n=1}\brb{\brb{1-\frac z{a_n}}e^{\frac{z}{a_n}}},
\ee
...
\be
\frac{\sin z}{z} = \prod^\infty_{n=1} \brb{\brb{1-\frac z{n\pi}}e^{\frac z{n\pi}}}\brb{\brb{1+\frac z{n\pi}}e^{-\frac z{n\pi}}} =  \prod^\infty_{n=1} \brb{1-\frac {z^2}{n^2\pi^2}}
\ee
...
\beast
f(z) & = & f(0) e^{\frac {f'(0)}{f(0)}z}\prod^\infty_{n=1}\brb{\brb{1-\frac z{a_n}}e^{\frac{z}{a_n}}} \\
& = & \prod^\infty_{k=1}\brb{1-\frac z{(2k-1)\pi/2}}\brb{1+\frac z{(2k-1)\pi/2}} = \prod^\infty_{k=1}\brb{1-\frac {4z^2}{(2k-1)^2\pi^2}}.
\eeast

Then for $z = \pi/4$, we have
\beast
0.707 \approx \frac {\sqrt{2}}2 = \cos\brb{\frac {\pi}4} & = & \prod^\infty_{k=1}\brb{1-\frac {1}{4(2k-1)^2}} =  \frac 34 \prod^\infty_{k=2}\brb{1-\frac {1}{4(2k-1)^2}} = \frac 34 \cdot \frac{107}{108} \prod^\infty_{k=3}\brb{1-\frac {1}{4(2k-1)^2}}\\
& = & \frac{107}{144} \prod^\infty_{k=3}\brb{1-\frac {1}{4(2k-1)^2}} = 0.743 \prod^\infty_{k=3}\brb{1-\frac {1}{4(2k-1)^2}} = \dots.
\eeast
\end{example}
...
%Prove that
%\be
%\brb{1+\brb{\frac kx}^2}\brb{1 + \brb{\frac{k}{x - 2\pi}}^2}\brb{1 + \brb{\frac{k}{x+2\pi}}^2}\brb{1 + \brb{\frac{k}{x-4\pi}}^2}\brb{1 + \brb{\frac{k}{x+ 4\pi }}^2} \dots = \frac{\cosh k - \cos x}{1-\cos x}.\nonumber
%\ee
%\end{problem}
%
...
& \leq & \int^1_{-1} \brb{\abs{x}^2+ \abs{y}^2} dt \leq \int^1_{-1} dt = 2.
\eeast

\item [(ii)] Similar, we use modulus inequality to have $z(t) = e^{it}$, $t\in [-\pi/2,\pi/2]$,
\be
\abs{\int_C (x^2 + iy^2)dz} \leq \int^{\pi/2}_{-\pi/2} \brb{\abs{x}^2 + \abs{y}^2} \abs{ie^{it}} dt = \int^{\pi/2}_{-\pi/2} dt = \pi.
\ee
...
\beast
\text{(i)}\ \sum^\infty_{k=1} \frac 1k (z-i)^k,\quad \text{(ii)}\ \sum^\infty_{k=1} k^{\ln k} (z-2)^k,\quad \text{(iii)} \ \sum^\infty_{k=1}\brb{\frac zk}^k ,\quad \text{(iv)}\ \sum^\infty_{k=1} \brb{1+\frac 1k}^{k^2} z^k,\quad \text{(v)}\ \sum^\infty_{k=1}(-1)^k z^{2k}.
\eeast
\end{problem}
...
\be
\ln \brb{\lim_{k\to \infty}\sqrt[k]{k^{\ln k}}} = \lim_{k\to \infty}\ln \brb{\sqrt[k]{k^{\ln k}}} = \lim_{k\to \infty} \frac{\brb{\ln k}^2}k = 0.
\ee
...
\be
\frac 1R = \lim_{k\to \infty} \frac{\brb{\frac 1{k+1}}^{k+1}}{\brb{\frac 1k}^k} = \lim_{k\to \infty} \frac 1{k+1} \lim_{k\to \infty} \frac 1{\brb{1+\frac 1k}^k} = 0 \cdot \frac 1e = 0.
\ee
...
\be
\frac 1R = \lim_{k\to \infty} \sqrt[k]{\brb{1+\frac 1k}^{k^2}} = \lim_{k\to \infty}\brb{1+\frac 1k}^k = e,
\ee
